<template>
    <center>
        <div class="search">
            ...
            <input type="radio" v-model="picked" value="oldcar" name="oldCard"> Ikinci El Araba<br> 
            Vade : <input class="values" type="text" name="vade" placeholder="Vadeyi Giriniz" v-model="vade" @keyup="(event) => handleHesap(event, 'vade')"> 
            Toplam Kredi: <input class="values" type="text" name="totalKredi" placeholder="Krediyi Giriniz" v-model="kredi" @keyup="(event) => handleHesap(event, 'kredi')"> 
            Aylik : <input class="values" type="text" name="aylik" placeholder="Aylık Odeme" v-model="aylik"
